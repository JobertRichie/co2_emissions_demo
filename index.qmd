...
table_df["Relative Change"] = table_df["Absolute Change"] * 100 / table_df["2000"]
...
emissions_long = pd.melt(
    emissions, id_vars="country", var_name="year", value_name="emissions"
)
...
emissions_long_subset = emissions_long_1990_2022.query(
    "country in ['Cameroon', 'Estonia', 'Mexico', 'Malaysia', 'Australia']"
)
...
fig_chart = px.line(
    ...
    y="emissions",
    color="country",
    title="Trends in CO2 emissions from 1990 to 2022 for five countries",
)

fig_chart
```

Interpretation: **Mexico** has the highest emissions over time, with an overall increasing trend between 1990 and 2022, followed by **Australia** which also shows an overall increasing trend over time, **Malaysia**. The two least polluant countries among the five are **Cameroon** and **Estonia**.
